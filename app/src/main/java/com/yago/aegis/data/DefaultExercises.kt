...
object DefaultExercises {
    ...
    private val pecho = listOf(
        ...
        ex("Fondos en Paralelas", "PECHO", "PUSH", listOf(c(PECHO_INFERIOR, 55), c(TRICEPS, 30), c(DELTOIDE_ANTERIOR, 15)), "body", loadType = "BODYWEIGHT"),
        ex("Flexiones", "PECHO", "PUSH", listOf(c(PECHO_MEDIO, 60), c(TRICEPS, 25), c(DELTOIDE_ANTERIOR, 15)), "body", loadType = "BODYWEIGHT"),
        ex("Flexiones Declinadas", "PECHO", "PUSH", listOf(c(PECHO_SUPERIOR, 55), c(TRICEPS, 25), c(DELTOIDE_ANTERIOR, 20)), "body", loadType = "BODYWEIGHT"),
        ...
        ex("Fondos Asistidos Máquina", "PECHO", "PUSH", listOf(c(PECHO_INFERIOR, 55), c(TRICEPS, 30), c(DELTOIDE_ANTERIOR, 15)), loadType = "ASSISTED"),
    ...
    private val espalda = listOf(
        ...
        ex("Dominadas", "ESPALDA", "PULL", listOf(c(DORSAL, 65), c(BICEPS, 20), c(ROMBOIDES, 10), c(TRAPECIO, 5)), "body", loadType = "BODYWEIGHT"),
        ex("Dominadas Supinas", "ESPALDA", "PULL", listOf(c(DORSAL, 55), c(BICEPS, 30), c(ROMBOIDES, 15)), "body", loadType = "BODYWEIGHT"),
        ex("Dominadas Neutras", "ESPALDA", "PULL", listOf(c(DORSAL, 60), c(BICEPS, 25), c(ROMBOIDES, 15)), "body", loadType = "BODYWEIGHT"),
        ex("Dominadas Asistidas Máquina", "ESPALDA", "PULL", listOf(c(DORSAL, 65), c(BICEPS, 20), c(ROMBOIDES, 15)), "layers", loadType = "ASSISTED"),
        ...
        ex("Remo Invertido", "ESPALDA", "PULL", listOf(c(DORSAL, 50), c(ROMBOIDES, 30), c(BICEPS, 20)), "body", loadType = "BODYWEIGHT"),
    ...
    private val hombros = listOf(
        ...
        ex("Flexiones Pike", "HOMBROS", "PUSH", listOf(c(DELTOIDE_ANTERIOR, 60), c(TRICEPS, 30), c(DELTOIDE_LATERAL, 10)), "body", loadType = "BODYWEIGHT"),
        ex("Flexiones Pino", "HOMBROS", "PUSH", listOf(c(DELTOIDE_ANTERIOR, 55), c(TRICEPS, 35), c(DELTOIDE_LATERAL, 10)), "body", loadType = "BODYWEIGHT"),
    ...
    private val triceps = listOf(
        ...
        ex("Fondos en Banco", "TRÍCEPS", "PUSH", listOf(c(TRICEPS, 75), c(DELTOIDE_ANTERIOR, 15), c(PECHO_INFERIOR, 10)), "body", loadType = "BODYWEIGHT"),
        ...
        ex("Flexiones Diamante", "TRÍCEPS", "PUSH", listOf(c(TRICEPS, 60), c(PECHO_MEDIO, 25), c(DELTOIDE_ANTERIOR, 15)), "body", loadType = "BODYWEIGHT"),
    ...
    private val piernas = listOf(
        ...
        ex("Sentadilla Sissy", "PIERNAS", "LEGS", listOf(c(CUADRICEPS, 100)), "body", loadType = "BODYWEIGHT"),
        ...
        ex("Gemelo de Pie", "PIERNAS", "LEGS", listOf(c(GEMELOS, 100)), "body", loadType = "BODYWEIGHT"),
        ex("Gemelo en Máquina de Pie", "PIERNAS", "LEGS", listOf(c(GEMELOS, 100))),
        ex("Gemelo en Prensa", "PIERNAS", "LEGS", listOf(c(GEMELOS, 100))),
        ex("Gemelo Burro", "PIERNAS", "LEGS", listOf(c(GEMELOS, 100)), "body", loadType = "BODYWEIGHT"),
        ex("Gemelo a una Pierna", "PIERNAS", "LEGS", listOf(c(GEMELOS, 100)), "body", loadType = "BODYWEIGHT"),
        ...
        ex("Sentadilla Pistol", "PIERNAS", "LEGS", listOf(c(CUADRICEPS, 60), c(GLUTEO, 30), c(ISQUIOTIBIALES, 10)), "body", loadType = "BODYWEIGHT"),
        ex("Curl Femoral Nórdico", "PIERNAS", "LEGS", listOf(c(ISQUIOTIBIALES, 100)), "body", loadType = "BODYWEIGHT"),
    ...
    private fun ex(
        ...
        loadType: String? = null   // null = NORMAL; "BODYWEIGHT" / "ASSISTED" para peso corporal/asistido
    ) = Exercise(
        ...
        iconName = icon,
        notes = "",
        isBodyweight = loadType == "BODYWEIGHT",
        lastPerformance = "",
        oneRepMax = 0.0,
        bestSet = "--",
        history = emptyList(),
